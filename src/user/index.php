    ...
    <body>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="shop.php" class="nav-item nav-link" style="margin-right: 80px;">Shop</a>
                        </div>
                        <div class="d-flex m-3 me-0">
                            <button class="btn-search btn border border-secondary btn-md-square rounded-circle bg-white me-4" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fas fa-search text-primary"></i></button>
                            <a href="<?php session_start(); echo isset($_SESSION['email']) ? 'cart.php' : 'login.php'; ?>" class="position-relative me-4 my-auto">
                                <i class="fa fa-shopping-bag fa-2x"></i>
                            </a>
                            <a href="./login.php" class="my-auto">
                                <i class="fas fa-user fa-2x"></i>
                                <span><?php 
                                    $email = mysqli_real_escape_string($code, $_SESSION['email']);
                                    $qr1 = mysqli_query($code, "SELECT name FROM user WHERE email = '$email'");
                                    $name = mysqli_fetch_assoc($qr1);
                                    echo $name['name'];
                                ?></span>
                            </a>
                        </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="img_container" style="display: flex; justify-content: center;">
                <img src="./img/Minimalist Fresh Market Instagram Post.png" alt="" style="height: 550px; width: 550px; object-fit: contain; margin-top: 108px;">
            </div>
        </div>
        <!-- Panel End -->
                        ...
                        <div id="tab-2" class="tab-pane fade p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php
                                        $qr = mysqli_query($code, "SELECT * FROM product WHERE category = 'Vegetable' LIMIT 8");
                        ...
                        <div id="tab-3" class="tab-pane fade p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <?php
                                        $qr = mysqli_query($code, "SELECT * FROM product WHERE category = 'Fruit' LIMIT 8");
