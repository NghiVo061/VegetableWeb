            ...
            <div class="container py-5">
                <div class="row g-4 mb-5">
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            <?php 
                                if (isset($_GET['id'])) {
                                    $_id = intval($_GET['id']); // Đảm bảo ID là số nguyên để tránh lỗi SQL Injection
                                    ...
                                    if ($row = mysqli_fetch_array($qr3)) {
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <p class="mb-4"><?php echo $row['details_desc']; ?></p>
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <?php
                                            if (isset($_GET['id'])) {
                                                ...
                                                if ($row = mysqli_fetch_array($qr3)) { 
                                                    // Nếu truy vấn có kết quả, hiển thị thông tin sản phẩm
                                                    ?>
                                                        ...
                                                        <div class="row g-4">
                                                            <div class="col-6">
                                                                <div class="row text-center align-items-center justify-content-center py-2">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <p class="mb-0"><?php echo $row['origin']; ?></p>
                                                                    </div>
                                                                </div>
                                                                <div class="row bg-light text-center align-items-center justify-content-center py-2">
                                                                    <div class="col-6">
                                                                        <p class="mb-0">Vitamin</p>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <p class="mb-0"><?php echo $row['Vitamin']; ?></p>
                                                                    </div>
                                                                </div>
                                                                <div class="row text-center align-items-center justify-content-center py-2">
                                                                    <div class="col-6">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <p class="mb-0"><?php echo $row['Benefits']; ?></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        <?php 
                            $qr4 = mysqli_query($code, "SELECT * FROM product
                                                        ORDER BY price ASC
                                                        LIMIT 8;
                                                        ");
